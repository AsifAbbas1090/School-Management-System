...
import { usersService, subjectsService } from '../../services/api';
...
const TeachersPage = () => {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            const teachersResponse = await usersService.getTeachers();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (modalMode === 'add') {
                ...
                const response = await usersService.updateUser(selectedTeacher.id, updateData);
                if (response.success && response.data) {
