...
import { classesService, sectionsService, subjectsService, usersService } from '../../services/api';
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                if (teachersRes.success) setTeachers(teachersRes.data.data || teachersRes.data || []);
            } catch (err) {
                console.error(err);
